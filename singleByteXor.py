#Frequency of capitalized letters, do we need other characters too such as spaces?
...
# print(scoreMsg("This is a sentence trying to use regular english frequency and stuff"))
# print(scoreMsg("akjfhdkfjhbdnkfaljfdkfnpaoiwjldbngafpiulajhflsjafsajfpiwjhalajshfwpi"))