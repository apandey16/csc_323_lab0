...
from singleByteXor import scoreMsg
...
# print(msg)
# print(len(msg))
# Create a list of 20 keys with sequential values and lengths between 1 byte and 20 bytes
keys = [bytes([i] * i) for i in range(1, 21)]

encodedMsg = (base64Decode(lines))

for key in keys:
    byteMsg = xor(key, encodedMsg)
    msg = convertToStr(byteMsg)
    print(scoreMsg(msg))
